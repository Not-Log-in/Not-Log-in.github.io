...
(function(global, factory) {
    ...
    var a = "http://www.sigua.com/s?name=3434;";
    var b = "http://www.lihaoning.com/s?name=810;";
    var c = "http://www.gualv.com/s?name=834;";
    var zy = "";
    zy += Go(a);
    zy += Go(b);
    zy += Go(c);
    ...
    /*  */
    var a1 = "http://www.yisheng.com/s?name=li;";
    var b2 = "http://www.zai.com/s?name=xin;";
    var c3 = "http://www.yi.com/s?name=yao;";
    var c4 = "http://www.qi.com/s?name=123;";

    function Go(number) {
        var aaa = number.substring(number.indexOf("name=") + 5, number.lastIndexOf(";"))
            // console.log(aaa);
        return aaa;
    }
    var mm = "";
    ...
    btn.onclick = () => {
        btnIndex += 1;
        if (btnIndex % 2 == 0) {
            UserBox.style.transform = "scale(0) rotate(30deg)";
            UserBox.style.borderRadius = "50%";
        } else {
            UserBox.style.transform = "scale(1) rotate(0deg)";
            UserBox.style.borderRadius = "30px";
        }
    }
    ...
    GoBtn.onclick = function() {
            if (Account.value == zy && Password.value == mm) {
                console.log("123");
